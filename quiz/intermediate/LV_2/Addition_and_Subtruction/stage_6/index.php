...
function generateQuestions($count = 175)
{
    $questions = [];
    for ($i = 0; $i < $count; $i++) {
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $count = isset($_GET['count']) ? intval($_GET['count']) : 175;

    if ($count < 1 || $count > 175) {
        $count = 100;
    }
