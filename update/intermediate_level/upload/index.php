...
function createUserData($userData)
{
    ...
    // Determine class from the user data (if not provided, set default as beginner)
    $userClass = isset($userData['class']) ? $userData['class'] : 'intermediate';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $fileName = '../storage/users_intermediate_data.json';
